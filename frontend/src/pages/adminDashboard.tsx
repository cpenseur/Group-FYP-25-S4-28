...
const initialUsers = [
  {
    name: "Sarah Owen",
    email: "sarah@dreamplanner.com",
    status: "Active",
    date: "2023-06-11",
  },
  {
    name: "Liam Park",
    email: "liam@exploreinc.com",
    status: "Pending",
    date: "2023-05-22",
  },
  {
    name: "Vince Gomez",
    email: "vince@backpacker.io",
    status: "Manager",
    date: "2023-03-30",
  },
  {
    name: "Emma Thompson",
    email: "emma@blueskyapp.com",
    status: "Suspended",
    date: "2022-12-09",
  },
];
...
export default function AdminDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<"users" | "moderation">(
    "moderation"
  );
  ...
  const filteredModerationItems = showPendingOnly
  ...
  const handleApprove = (index: number) => {
    setModerationItems((items) =>
      items.map((item, i) =>
        i === index ? { ...item, state: "approved" } : item
      )
    );
  };
  ...
  const handleReject = (index: number) => {
    setModerationItems((items) =>
      items.map((item, i) =>
        i === index ? { ...item, state: "rejected" } : item
      )
    );
  };
      ...
      <div className="admin-shell">
        ...
        <main className="admin-main">
          ...
          {activeSidebarItem === "dashboard" && (
            <header className="admin-header">
              <div>
                ...
                <p>
                  User Account Management, Destination Data, System Monitoring &
                  Content Moderation
                </p>
              </div>
              ...
              <div className="header-actions">
                ...
                <div className="admin-user-pill">
                  ...
                  <div>
                    ...
                    <span className="pill-name">Administrator</span>
                  </div>
                </div>
              </div>
            </header>
          ...
          <section className="content-grid">
                ...
                <div className="card card-moderation">
                    ...
                    {activeTab === "moderation" && (
                      <button
                        className={
                          ...
                          (showPendingOnly ? "btn-filter-active" : "")
                        }
                  ...
                  <div className="tabs tabs--underline">
                    <button
                      className={
                        "tab " +
                        (activeTab === "users" ? "tab--underline-active" : "")
                      }
                            ...
                            >
                              <div className="moderation-main">
                                <div className="moderation-title-row">
                                  ...
                                  {item.severity === "red" && (
                                    <span className="moderation-tag moderation-tag--red">
                                      !
                                    </span>
                                  )}
                                  {item.severity === "orange" && (
                                    <span className="moderation-tag moderation-tag--orange">
                                      •
                                    </span>
                                  )}
                                  {isApproved && (
                  ...
                  <div className="side-block side-block--primary">
                    ...
                    {reviewClicked && (
                      <p className="side-note">
                        Opened verification queue (demo behavior).
                      </p>
                    )}
                  </div>
                </aside>
            ...
            {/* REPORTS VIEW – same layout as screenshot, TripMate content */}
            {activeSidebarItem === "reports" && (
              <>
                <div className="card reports-main-card">
                  ...
                  {/* tabs row like Performance / Holdings / Positions etc. */}
                  <div className="reports-tabs">
                    <button className="reports-tab reports-tab--active">
                      Overview
                    </button>
                  ...
                  <div className="report-stats-row">
                    <div className="report-stat-card">
                      ...
                      <p className="report-stat-sub report-stat-sub--up">
                        ↑ 10% vs last month
                      </p>
                    </div>
                    <div className="report-stat-card">
                    ...
                    <div className="report-stat-card">
                      ...
                      <p className="report-stat-sub report-stat-sub--down">
                        ↓ 3 vs last month
                      </p>
                    </div>
                  </div>

                  {/* “Financial Performance” style card, but for report activity */}
                  ...
                  {/* bottom card: your actual report list */}
...
@media print {
  ...
  /* optional: remove backgrounds/shadows so it looks clean */
  .admin-shell {
